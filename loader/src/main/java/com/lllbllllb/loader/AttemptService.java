...
@Slf4j
@Service
public class AttemptService implements Finalizable, Resettable {
    ...
    public AttemptResult registerSuccess(String preyName, long attemptNumber, long responseTime) {
    ...
    public AttemptResult registerTimeout(String preyName, long attemptNumber, long responseTime) {
